This is the ACT-R 6.0 source code distribution.

These directories contain all of the Lisp code needed to run ACT-R 6.0 and
...
Instructions on how to load and run ACT-R and the Environment can be found
in the QuickStart.txt file in the docs directory.  The tutorial units are 
located in the tutorial directory, and that is the recommended starting 
