...
;;; 2007.07.13 Dan
;;;             : * Added color as an option for buttons, but it doesn't
;;;             :   seem to display right (though the model still sees it
;;;             :   correctly).
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defmethod virtual-key-down :before ((device rpm-real-window) buts key)
   (declare (ignore-if-unused device buts key))
...
(defmethod make-button-for-rpm-window ((win rpm-real-window) &key (x 0) (y 0) (text "Ok")  (action nil) (height 18)  (width 60) (color 'gray))
...
(defmethod build-features-for ((self key-catcher)
